...
//ModalContainer  에서 키보드 출현시 팝업 뷰 올라가도록 설정을 추가한 컴포넌트

export default class ModalContainer2 extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <Modal transparent={true} >
        <KeyboardAvoidingView behavior={keyboardBehavior} style={styles.safeArea}>
